...
| 25 | Build the task-first business analysis workbench | in progress | Task 1/15 completed: 9 contract tests cover immutable snapshots, safe event summaries, strict transitions and replay sequences; Task 2 next |
