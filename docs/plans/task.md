...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–5/15 completed: document corpus and text dashboard add 4 tests; sections/lines/hashes, deduplication, partial failures, pending claims and conflicts covered; Task 6 next |
