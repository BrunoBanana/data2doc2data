...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–4/15 completed: model-free profile and versioned DashboardSpec add 7 tests; chart marks/encodings/transforms and results are bounded; Task 5 next |
