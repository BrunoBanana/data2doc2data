...
| 25 | Build the task-first business analysis workbench | in progress | Approved design and executable TDD plan: React task shell, local data/text dashboards, observable runs, evidence/hypothesis graphs, assistant drawer, and 3 use-test rounds |
