...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–3/15 completed: versioned contracts, private SQLite store, authenticated task/assets/run APIs, atomic run start and bounded owner-isolated replay; first batch verification in progress |
