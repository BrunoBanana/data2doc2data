...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–7/15 completed: unified local CLI/API/skip connection registry and authenticated provider API; secrets remain references; 60 focused tests pass; Task 8 next |
