...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–8/15 completed: React/TypeScript/Vite shell, locked offline dependencies, safe hashed asset serving, SPA fallback, Python package and ZIP inclusion; frontend tests/typecheck/build plus 32 focused Python tests pass; Task 9 next |
