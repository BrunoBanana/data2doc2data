...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–2/15 completed: 9 domain/event tests and 6 SQLite tests; private versioned store, fixed snapshots, transactional replay and status guards; Task 3 next |
