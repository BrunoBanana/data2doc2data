...
| 27 | Rebuild the product around dual-runner Agent Flow and live data-text cross-reasoning | in progress | Design approved: Demo and connected runners share typed events, local tools, live canvas, resumable sessions, project knowledge evolution, and Web/CLI/MCP HTML reports. |
