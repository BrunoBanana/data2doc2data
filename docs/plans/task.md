...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–11/15 completed: executable local analysis runs, ordered observable events, calculation/retrieval summaries, lazy React Flow evidence graph, structured hypotheses and no private reasoning fields; Task 12 assistant drawer next |
