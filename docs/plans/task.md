...
| 25 | Build the task-first business analysis workbench | in progress | Tasks 1–10/15 completed: Flint/ECharts data Dashboard, KPI provenance, immutable snapshot registry, optional Markdown/TXT preprocessing and pending-claim text Dashboard; Task 11 observable run views next |
